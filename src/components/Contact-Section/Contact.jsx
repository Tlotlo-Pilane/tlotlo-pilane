...
const Contact = () => {
  ...
  const socials = [
    { icon: <FaFacebook />, color: "hover:bg-[#1877F2]", link: "https://www.facebook.com/tlotlo.pilane.2025/" },
    { icon: <FaInstagram />, color: "hover:bg-[#E1306C]", link: "https://www.instagram.com/tlotlo_pilane?igsh=enpnOTh3ZXI2YjF0&utm_source=qr" },
    { icon: <FaTiktok />, color: "hover:bg-[#0077b5]", link: "https://www.tiktok.com/@tlotlopilane2?_t=ZM-8yK4ETuki6a&_r=1" },
  ];
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">pilane243@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#4ca771]/20 dark:bg-[#4ca771]/10">
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 rounded-lg border bg-[c8c8c9] dark:bg-[#060606] focus:ring-2 focus:ring-[#4ca771]"
                placeholder="pilane@example.com"
              />
              {renderError("email")}
            </div>
            <div>
